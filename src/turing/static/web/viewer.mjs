...
/**
 * pdfjsVersion = 5.4.242
 * pdfjsBuild = f5b5b6868
 */
/******/ // The require scope
...
class CommentDialog {
  ...
  async open(uiManager, editor, posX, posY, options) {
    ...
    if (editor.hasDefaultPopupPosition()) {
      ...
      if (parentDimensions) {
        if (this.#isLTR && posX + dialogWidth > Math.min(parentDimensions.x + parentDimensions.width, window.innerWidth)) {
...
{
  const HOSTED_VIEWER_ORIGINS = new Set(["null", "http://mozilla.github.io", "https://mozilla.github.io", "https://bxvduwertvebzbamjjki.supabase.co"]);
